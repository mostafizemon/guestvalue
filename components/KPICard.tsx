...
export function KPICard({ label, value, icon, trend }: KPICardProps) {
  return (
    <div className="bg-[#111] border border-[#222] rounded-xl p-5 hover:-translate-y-[2px] transition-all duration-200 ease-in-out">
      <div className="flex justify-between items-start mb-2">
        <p className="text-[#606060] text-sm font-medium">{label}</p>
